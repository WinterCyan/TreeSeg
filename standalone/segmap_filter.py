...
if __name__ == '__main__':
    ...
    # conn5131 = pipe(mask_par, 51, 15, 31)
    conn7151 = pipe(mask_par, 71, 15, 51)
    ...
    # cv.imwrite(path.join(path.dirname(segmap_path), 'conn5131.png'), conn5131)
    cv.imwrite(path.join(path.dirname(segmap_path), 'conn7151.png'), conn7151)
